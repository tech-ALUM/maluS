"""Shared fixtures for the service-layer tests: a fresh in-memory SQLite
session (mirrors ``tests/db/conftest.py`` — the service layer sits directly
on top of the same DB session)."""
