...
The acquisition timeout shall be configurable by the operator. {COMM|type=technical|sev=major: the acquisition timeout is not bounded anywhere}
...
The node exposes a serial interface at 115200 baud. {SUGG: "115200" -> "115,200"}
